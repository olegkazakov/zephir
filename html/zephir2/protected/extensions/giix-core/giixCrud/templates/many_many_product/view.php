...
<div class="details_view">
    <div class="large_pic_wrapper" id="large_wrapper_<?php echo '<?php '; ?>echo $model->id;<?php echo '?>'; ?>">
        <img id="<?php echo '<?php '; ?>echo 'large_' . $model->id;<?php echo '?>'; ?>"
             src="<?php echo '<?php  '; ?> echo $img_url;<?php echo '?>'; ?>?<?php echo '<?php '; ?>echo time();<?php echo '?>'; ?>"
             title="image_<?php echo '<?php '; ?>echo $model->id;<?php echo '?>'; ?>"/>
    </div>
