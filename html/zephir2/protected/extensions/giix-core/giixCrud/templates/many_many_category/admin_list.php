...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-header">
      <h2><?php echo $this->modelClass;?></h2><br>
        ...
        <a   class='headerlinks' href="<?php echo '<?php echo '; ?>$this->createUrl('index_list');<?php echo '?>'; ?>">Frontend ListView</a>
    </div>
    <br>
    <div class="content-box-content  clearfix" id="wrapper">
        <ul>
           ...
           <p>Click on a <?php echo $this->class2var($this->modelClass);?> node  to filter <?php echo  $relatedModelClass; ?> records</p>
            <div style="margin-bottom: 70px;">
            <div style="float:left">
                <input id="reload" type="button" style="display:block; clear: both;" value="Refresh <?php echo $this->modelClass;?>"
                       class="client-val-form button">
            </div>
            <div style="float:left">
                <input id="add_root" type="button" style="display:block; clear: both;" value="Create Root <?php echo $this->modelClass;?>"
                       class="client-val-form button">
            </div>
            <div style="float:right">
                <input id="add_<?php echo $this->class2var($relatedModelClass);?>" type="button" style="display:block; clear: both;" value="New <?php echo $relatedModelClass;?>"
                       class="client-val-form button">
            </div>
            <div style="float:left">
        ...
        <div id="<?php echo '<?php echo '; ?><?php echo $this->modelClass; ?>::ADMIN_TREE_CONTAINER_ID<?php echo ';?>'; ?>" class='left'>
        ...
        <div id='category_info'>
            ...
            <div id='title'>
                ...
                <?php else : ?>
                <h3><?php echo '<?php echo '; ?><?php echo $this->modelClass; ?>::model()->findByPK($category_id)->name;  ?></h3>
                <?php  endif;?>
            </div>
        </div>
...
//View
        $('a.<?php echo $this->class2var($relatedModelClass);?>_properties').bind('click', function() {
            $.ajax({
                type: "POST",
                url: "<?php echo '<?php echo '; ?>$baseUrl<?php echo ';?>'; ?>/<?php echo $this->class2var($relatedModelClass);?>/returnProductView/",
